    ...
    proxiesToShow = filteredProxies.slice(0, count);
            ...
            for (const proxy of proxiesToShow) {
                ...
                if (countryParam1) {
                    ...
                    if (type === 'vless') {
                        if (wildcard) {
                            urlString = `vless://${uuid}@${wildcard}:443?encryption=none&type=ws&host=${wildcard}tp1.cepu.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=${wildcard}tp1.cepu.bmkg.xyz#(${wildcard})${country}+${provider}`;
                        } else {
                            urlString = `vless://${uuid}@tp1.cepu.bmkg.xyz:443?encryption=none&type=ws&host=tp1.cepu.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=tp1.cepu.bmkg.xyz#${country}+${provider}`;
                        }
                    } else if (type === 'trojan') {
                        if (wildcard) {
                            urlString = `trojan://${uuid}@${wildcard}:443?encryption=none&type=ws&host=${wildcard}tp1.cepu.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=${wildcard}tp1.cepu.bmkg.xyz#(${wildcard})${country}+${provider}`;
                        } else {
                            urlString = `trojan://${uuid}@tp1.cepu.bmkg.xyz:443?encryption=none&type=ws&host=tp1.cepu.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=tp1.cepu.bmkg.xyz#${country}+${provider}`;
                        }
                    } else if (type === 'ss') {
                        ...
                        if (wildcard) {
                            urlString = `ss://bm9uZTo1ZDJlYmQyYS05Y2I5LTRkMWItYWY1NS04NjE3ZDNlODFmMzk%3D@${wildcard}:443?encryption=none&type=ws&host=${wildcard}tp1.cepu.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=${wildcard}tp1.cepu.bmkg.xyz#(${wildcard})${country}+${provider}`;
                        } else {
                            urlString = `ss://bm9uZTo1ZDJlYmQyYS05Y2I5LTRkMWItYWY1NS04NjE3ZDNlODFmMzk%3D@tp1.cepu.bmkg.xyz:443?encryption=none&type=ws&host=tp1.cepu.bmkg.xyz&path=%2F${ip}-${port}&security=tls&sni=tp1.cepu.bmkg.xyz#${country}+${provider}`;
                        }
                    }
